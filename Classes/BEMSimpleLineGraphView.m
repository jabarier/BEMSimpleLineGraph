...
#pragma clang diagnostic pop
            ...
            if (self.positionYAxisRight) {
                positionOnXAxis = (((self.frame.size.width - self.YAxisLabelXOffset - 10) / (numberOfPoints - 1)) * i);
            } else {
                positionOnXAxis = (((self.frame.size.width - self.YAxisLabelXOffset - 10) / (numberOfPoints - 1)) * i) + self.YAxisLabelXOffset;
            }
...
- (void)drawLine {
    ...
    line.rightPadding = self.rightPadding;
...
- (UILabel *)xAxisLabelWithText:(NSString *)text atIndex:(NSInteger)index {
    ...
    if (self.positionYAxisRight) {
        ...
        positionOnXAxis = (((self.frame.size.width - self.YAxisLabelXOffset - 10) / (numberOfPoints - 1)) * index) + self.YAxisLabelXOffset + horizontalTranslation;
    }
